...
import { BaseDocument, BaseEntity } from './base.entity';
...
> {
  ...
  async find(criteria: FilterQuery<Entity>): Promise<Entity[] | []> {
    return await this.model.find({ ...criteria, isDeleted: false });
  }
